...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full" }, _attrs))}> Projects Projects that i am working on </div>`);
}
const _sfc_setup$1 = _sfc_main$1.setup;
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Contents/P/Content.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_ContentsPContent = __nuxt_component_1;
  ...
  _push(ssrRenderComponent(_component_ContentsPContent, null, null, _parent));
  _push(`</div>`);
...
//# sourceMappingURL=projects-4282295c.mjs.map
